                ...
                @foreach($fields as $index => $field)
                    <tr>
                        <td style="text-align: center">
                            <input type = "checkbox" name = "select[]" id = "select_{{$index}}" value = "{{$field->Field}}" {{($field->Null=='NO' && $field->Key !='PRI') ? 'checked': ''}}/>
                        ...
                        <td style="text-align: center">
                            <input type = "checkbox" name = "required[]" id = "required_{{$index}}" {{($field->Null=='NO' && $field->Key !='PRI') ? 'checked': ''}} value = "{{$field->Field}}"/>
